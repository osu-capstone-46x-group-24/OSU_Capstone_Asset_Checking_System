...
// using simple divs instead of material-tailwind Dialog components
// import {
//     DialogHeader,
//     DialogBody,
//     DialogFooter,
...
export default function DatetimeModal({
    ...
    // trigger entrance animation whenever the modal is opened
    useEffect(() => {
        if (open) {
            setAnimateIn(false);
                ...
                <div className="fixed inset-0 z-50">
                    <div className="relative h-full flex justify-center items-start">
                        <div
                            ...
                            className="pointer-events-auto bg-white rounded-lg shadow-2xl shadow-black/75 w-full max-w-md p-6 text-gray-800 text-left animate-slide-in"                        >
                            ...
                            {/* footer */}
                            <div className="flex justify-end gap-2 pt-4 text-white">
                                <ButtonDefault onClick={onClose}>Cancel</ButtonDefault>
                                <div className="flex items-center gap-2">
                                    <ButtonDefault
                                        onClick={handleConfirm}
                                        props={{ disabled: !(unsure || datetime !== "") } as any}
